...
public class G0Transaction2 implements Runnable {
    private int delay;
    private GraphDatabaseService graphDb;

    public G0Transaction2(int delay, GraphDatabaseService graphDb) {
        this.delay = delay;
    ...
    public void run() {
        ...
        try (Transaction tx = graphDb.beginTx()) {
            ...
            sleep(delay);
            System.out.println("> MATCH (n:Test) RETURN n.id AS id, n.value AS val -- " + Thread.currentThread().getName());
